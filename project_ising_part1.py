...
# File: project_ising_part1.py
# Description: Plots for energy and magnetization as a function of temperature.
# Date: 2019/12/05
"""
...
temperature = np.linspace(0, 6, points)         # Setup the temperature independent variable.
